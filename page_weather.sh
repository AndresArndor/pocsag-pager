...
humidity=`cat /tmp/pager/weather_station_report | grep -in "Latest recived weather reports" -A 40 | grep 360 | awk -F'[ ,]+' '{print $2}' | cut -f1 -d"&"`
export $humidity
...
sudo RemoteCommand 7642 page 1234567 "R4CHD, weather: T: ${temperature}, H: ${humidity}, P: ${pressure}, W: ${wind_gust}"
